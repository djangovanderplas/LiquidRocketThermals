...
class Settings2D:
    def __init__(self, cell_size, time_step, tolerance, max_iter, save_fig, print_result, run_time, start_idx=-1, adaptive_up=1.4, adaptive_recover=1.05, log_thermocouples=False, thermocouples=0):
        ...
        self.adaptive_recover = adaptive_recover                    # gentle step up after time step reductions to avoid solver stalls
...
class Output1D:
    ...
    def write_csv(self):
        ...
        csv_path = self.folder_path / "sim_data.csv"
