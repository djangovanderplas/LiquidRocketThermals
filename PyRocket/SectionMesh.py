...
def get_section_mesh(cell_size, idx, cooling_geometry):
    r_c = cooling_geometry.geom[idx,1]       # inner chamber radius
    h_c = cooling_geometry.h_c[idx]          # height of the cooling channel
    t_w_i = cooling_geometry.t_w_i[idx]      # inner wall thickness
    t_w_o = cooling_geometry.t_w_o[idx]      # outer wall thickness
    psi_c = cooling_geometry.psi_c[idx]      # radial section of single cooling channel
    psi_w = cooling_geometry.psi_w[idx]      # radial section of single wall segment
