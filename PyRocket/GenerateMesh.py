...
y_inner = context.geometry[:, 1]
wall_thickness = context.cooling_geom.t_w_i + context.cooling_geom.h_c + context.cooling_geom.t_w_o
y_outer = y_inner + wall_thickness

x_inner = context.geometry[:, 0]
x_outer = context.geometry[:, 0]
